...
enum smt2_symbol {
  ...
  SMT2_SYM_STRING,
  SMT2_SYM_REGLANG,
  SMT2_SYM_STR_DOT_PLUSPLUS,
  SMT2_SYM_STR_DOT_LEN,
  SMT2_SYM_STR_DOT_LT,
  SMT2_SYM_STR_DOT_TO_RE,
  SMT2_SYM_STR_DOT_IN_RE,
  SMT2_SYM_STR_DOT_LE,
  SMT2_SYM_STR_DOT_AT,
  SMT2_SYM_STR_DOT_SUBSTR,
  SMT2_SYM_STR_DOT_PREFIXOF,
  SMT2_SYM_STR_DOT_SUFFIXOF,
  SMT2_SYM_STR_DOT_CONTAINS,
  SMT2_SYM_STR_DOT_INDEXOF,
  SMT2_SYM_STR_DOT_REPLACE,
  SMT2_SYM_STR_DOT_REPLACE_ALL,
  SMT2_SYM_STR_DOT_REPLACE_RE,
  SMT2_SYM_STR_DOT_REPLACE_RE_ALL,
  SMT2_SYM_STR_DOT_IS_DIGIT,
  SMT2_SYM_STR_DOT_TO_CODE,
  SMT2_SYM_STR_DOT_FROM_CODE,
  SMT2_SYM_STR_DOT_TO_INT,
  SMT2_SYM_STR_DOT_FROM_INT,
  SMT2_SYM_RE_DOT_NONE,
  SMT2_SYM_RE_DOT_ALL,
  SMT2_SYM_RE_DOT_ALLCHAR,
  SMT2_SYM_RE_DOT_PLUSPLUS,
  SMT2_SYM_RE_DOT_UNION,
  SMT2_SYM_RE_DOT_INTER,
  SMT2_SYM_RE_DOT_STAR,
  SMT2_SYM_RE_DOT_COMP,
  SMT2_SYM_RE_DOT_DIFF,
  SMT2_SYM_RE_DOT_PLUS,
  SMT2_SYM_RE_DOT_OPT,
  SMT2_SYM_RE_DOT_RANGE,
