...
static const uint8_t smt2_key[NUM_SMT2_SYMBOLS] = {
  ...
  SMT2_KEY_TYPE,         // SMT2_SYM_REGLANG
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_PLUSPLUS
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_LEN
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_LT
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_TO_RE
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_IN_RE
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_LE
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_AT
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_SUBSTR
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_PREFIXOF
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_SUFFIXOF
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_CONTAINS
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_INDEXOF
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_REPLACE
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_REPLACE_ALL
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_REPLACE_RE
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_REPLACE_RE_ALL
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_IS_DIGIT
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_TO_CODE
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_FROM_CODE
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_TO_INT
  SMT2_KEY_TERM_OP,      // SMT2_SYM_STR_DOT_FROM_INT
  SMT2_KEY_TERM,         // SMT2_SYM_RE_DOT_NONE
  SMT2_KEY_TERM,         // SMT2_SYM_RE_DOT_ALL
  SMT2_KEY_TERM,         // SMT2_SYM_RE_DOT_ALLCHAR
  SMT2_KEY_TERM_OP,      // SMT2_SYM_RE_DOT_PLUSPLUS
  SMT2_KEY_TERM_OP,      // SMT2_SYM_RE_DOT_UNION
  SMT2_KEY_TERM_OP,      // SMT2_SYM_RE_DOT_INTER
  SMT2_KEY_TERM_OP,      // SMT2_SYM_RE_DOT_STAR
  SMT2_KEY_TERM_OP,      // SMT2_SYM_RE_DOT_COMP
  SMT2_KEY_TERM_OP,      // SMT2_SYM_RE_DOT_DIFF
  SMT2_KEY_TERM_OP,      // SMT2_SYM_RE_DOT_PLUS
  SMT2_KEY_TERM_OP,      // SMT2_SYM_RE_DOT_OPT
  SMT2_KEY_TERM_OP,      // SMT2_SYM_RE_DOT_RANGE
...
static const int32_t smt2_val[NUM_SMT2_SYMBOLS] = {
  ...
  reglang_id,            // SMT2_SYM_REGLANG
  MK_STRING_CONCAT,      // SMT2_SYM_STR_DOT_PLUSPLUS
  MK_STRING_LEN,         // SMT2_SYM_STR_DOT_LEN
  MK_STRING_LT,          // SMT2_SYM_STR_DOT_LT
  MK_STRING_TO_RE,       // SMT2_SYM_STR_DOT_TO_RE
  MK_STRING_IN_RE,       // SMT2_SYM_STR_DOT_IN_RE
  MK_STRING_LE,          // SMT2_SYM_STR_DOT_LE
  MK_STRING_AT,          // SMT2_SYM_STR_DOT_AT
  MK_STRING_SUBSTR,      // SMT2_SYM_STR_DOT_SUBSTR
  MK_STRING_PREFIXOF,    // SMT2_SYM_STR_DOT_PREFIXOF
  MK_STRING_SUFFIXOF,    // SMT2_SYM_STR_DOT_SUFFIXOF
  MK_STRING_CONTAINS,    // SMT2_SYM_STR_DOT_CONTAINS
  MK_STRING_INDEXOF,     // SMT2_SYM_STR_DOT_INDEXOF
  MK_STRING_REPLACE,        // SMT2_SYM_STR_DOT_REPLACE
  MK_STRING_REPLACEALL,     // SMT2_SYM_STR_DOT_REPLACE_ALL
  MK_STRING_REPLACE_RE,     // SMT2_SYM_STR_DOT_REPLACE_RE
  MK_STRING_REPLACE_RE_ALL, // SMT2_SYM_STR_DOT_REPLACE_RE_ALL
  MK_STRING_IS_DIGIT,       // SMT2_SYM_STR_DOT_IS_DIGIT
  MK_STRING_TO_CODE,        // SMT2_SYM_STR_DOT_TO_CODE
  MK_STRING_FROM_CODE,      // SMT2_SYM_STR_DOT_FROM_CODE
  MK_STRING_TO_INT,         // SMT2_SYM_STR_DOT_TO_INT
  MK_STRING_FROM_INT,       // SMT2_SYM_STR_DOT_FROM_INT
  re_none_term,             // SMT2_SYM_RE_DOT_NONE    (in terms.h)
  re_all_term,              // SMT2_SYM_RE_DOT_ALL     (in terms.h)
  re_allchar_term,          // SMT2_SYM_RE_DOT_ALLCHAR (in terms.h)
  MK_REGLANG_CONCAT,        // SMT2_SYM_RE_DOT_PLUSPLUS
  MK_REGLANG_UNION,         // SMT2_SYM_RE_DOT_UNION
  MK_REGLANG_INTER,         // SMT2_SYM_RE_DOT_INTER
  MK_REGLANG_KLEENE,        // SMT2_SYM_RE_DOT_STAR
  MK_REGLANG_COMP,          // SMT2_SYM_RE_DOT_COMP
  MK_REGLANG_DIFF,          // SMT2_SYM_RE_DOT_DIFF
  MK_REGLANG_KLEENE_CROSS,  // SMT2_SYM_RE_DOT_PLUS
  MK_REGLANG_OPT,           // SMT2_SYM_RE_DOT_OPT
  MK_REGLANG_RANGE,         // SMT2_SYM_RE_DOT_RANGE
